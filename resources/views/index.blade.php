...
<div id="carousel" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="{{url('/images/library.jpg')}}" class="d-block w-100" alt="Library Image">
        </div>
        <div class="carousel-item">
          <img src="{{url('/images/library2.jpg')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="{{url('/images/library3.jpg')}}" class="d-block w-100" alt="...">
        </div>
      </div>
