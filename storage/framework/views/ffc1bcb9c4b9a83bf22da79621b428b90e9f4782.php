...
<html lang="en">
  <head>
    ...
    <style>
    .fondo{
        background-color:<?php echo e($fondo); ?>;
      }
      .showBooks{
  ...
  <body class="">
    ...
    <div class="container w-100 mx-5 my-3 p-2">
        <?php echo $__env->yieldContent('index_content'); ?>
    </div>
    <br>
...
<?php /**PATH C:\Program Files\XAMPP\htdocs\LaravelProject\LibraryApp\resources\views/layouts/layout.blade.php ENDPATH**/ ?>