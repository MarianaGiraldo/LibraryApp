...
<div class="row m-4 ">
        <div class="col">
            <h1>Edit User <?php echo e($user->firstName); ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\XAMPP\htdocs\LaravelProject\LibraryApp\resources\views/users/edit.blade.php ENDPATH**/ ?>