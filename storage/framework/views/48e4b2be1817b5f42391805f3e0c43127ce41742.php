...
<?php $__env->startSection('content'); ?>
      ...
      <h2 class="mx-auto text-center">Lendings History of user <?php echo e($user->firstName); ?> <?php echo e($user->lastName); ?></h2>
    ...
    <?php $__currentLoopData = $lendings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lending): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr class="table-light">
            ...
            <td><?php echo e(date("d/m/Y",strtotime($lending->created_at))); ?> </td>
        </tr>
        <?php $i++; ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\XAMPP\htdocs\LaravelProject\LibraryApp\resources\views/lendings/historyByUser.blade.php ENDPATH**/ ?>